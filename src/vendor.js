/* This file containe references to the vendor libraries
  ...
  cached until one of them change. So basically, this aboids
  ...
  Any files tht aren't referenced here will be bundled into
